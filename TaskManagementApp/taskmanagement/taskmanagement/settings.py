...
SECRET_KEY = 'django-insecure-j!toh%gox=3jo^!!^4u8bhev4=bp43rzk2mk2)#d+v3k)u$2e%'
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        {"name": "Home", "url": "admin:index", "permisisons": ["auth.view_user"]},

        {"name": "Support", "url": "https://github.com/farridav/django-jazzmin/issues", "new_window": True},

        {"name": "Contact Us", "url": "https://www.facebook.com/rh.bation", "new_window": True},
